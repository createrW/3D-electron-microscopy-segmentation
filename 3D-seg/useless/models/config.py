...
val_epochs = {'Task02_Heart': 10, 'Task03_Liver': 10, 'Task04_Hippocampus': 10, 'Task05_Prostate': 10,
              'Task07_Pancreas': 10, 'Task09_Spleen': 10}
...
batch_sizes = {'Task02_Heart': 2, 'Task03_Liver': 2, 'Task04_Hippocampus': 9, 'Task05_Prostate': 4,
               'Task07_Pancreas': 2, 'Task09_Spleen': 2}

base_outChanss = {'Task02_Heart': 16, 'Task03_Liver': 16, 'Task04_Hippocampus': 16, 'Task05_Prostate': 16,
                  'Task07_Pancreas': 16, 'Task09_Spleen': 16}

patch_sizes = {'Task02_Heart': [80, 192, 128], 'Task03_Liver': [128, 128, 128], 'Task04_Hippocampus': [40, 56, 40],
               'Task05_Prostate': [20, 192, 192], 'Task07_Pancreas': [96, 160, 128], 'Task09_Spleen': [96, 160, 128]}

nums_pool_per_axis = {'Task02_Heart': [4, 5, 5], 'Task03_Liver': [5, 5, 5], 'Task04_Hippocampus': [3, 3, 3],
                      'Task05_Prostate': [2, 5, 5], 'Task07_Pancreas': [4, 5, 5], 'Task09_Spleen': [4, 5, 5]}

pixel_spacings = {'Task02_Heart': [1.37, 1.25, 1.25], 'Task03_Liver': [1, 0.77, 0.77], 'Task04_Hippocampus': [1, 1, 1],
                  'Task05_Prostate': [3.6, 0.625, 0.625], 'Task07_Pancreas': [2.5, 0.8, 0.8],
                  'Task09_Spleen': [5, 0.8, 0.8]}  #

# data augmentation
# fixed nProcs_ind: T03,
nProcs_ind = {'Task02_Heart': 6, 'Task03_Liver': 20, 'Task04_Hippocampus': 5, 'Task05_Prostate': 8,
              'Task07_Pancreas': 15, 'Task09_Spleen': 10}  # number of processors
nProcs_uni = {'Task02_Heart': 4, 'Task03_Liver': 15, 'Task04_Hippocampus': 2, 'Task05_Prostate': 3,
              'Task07_Pancreas': 4, 'Task09_Spleen': 5}
qsizes_ind = {'Task02_Heart': 5, 'Task03_Liver': 8, 'Task04_Hippocampus': 10, 'Task05_Prostate': 5,
              'Task07_Pancreas': 8, 'Task09_Spleen': 5}  # queue_sizes
qsizes_uni = {'Task02_Heart': 5, 'Task03_Liver': 6, 'Task04_Hippocampus': 4, 'Task05_Prostate': 5, 'Task07_Pancreas': 6,
              'Task09_Spleen': 5}
num_patch_per_files = {'Task02_Heart': 2, 'Task03_Liver': 2, 'Task04_Hippocampus': 2, 'Task05_Prostate': 2,
                       'Task07_Pancreas': 2, 'Task09_Spleen': 2}

scale_probs = {'Task02_Heart': 0.5, 'Task03_Liver': 0.5, 'Task04_Hippocampus': 0.5, 'Task05_Prostate': 0.5,
               'Task07_Pancreas': 0.5, 'Task09_Spleen': 0.5}  # TBD

small_probs = {'Task02_Heart': 0.3, 'Task03_Liver': 0.3, 'Task04_Hippocampus': 0.3, 'Task05_Prostate': 0.3,
               'Task07_Pancreas': 0.3, 'Task09_Spleen': 0}  # oversample smallest objects.
fore_probs = {'Task02_Heart': 0.3, 'Task03_Liver': 0.3, 'Task04_Hippocampus': 0.3, 'Task05_Prostate': 0.3,
              'Task07_Pancreas': 0.3, 'Task09_Spleen': 0}  # TBD

deform_probs = {'Task02_Heart': 0.3, 'Task03_Liver': 0.3, 'Task04_Hippocampus': 0.3, 'Task05_Prostate': 0.3,
                'Task07_Pancreas': 0.3, 'Task09_Spleen': 0.3}
rotate_probs = {'Task02_Heart': 0.3, 'Task03_Liver': 0.3, 'Task04_Hippocampus': 0.3, 'Task05_Prostate': 0.3,
                'Task07_Pancreas': 0.3, 'Task09_Spleen': 0.3}
mirror_probs = {'Task02_Heart': 0.3, 'Task03_Liver': 0.3, 'Task04_Hippocampus': 0.3, 'Task05_Prostate': 0.3,
                'Task07_Pancreas': 0.3, 'Task09_Spleen': 0.3}
