...
from densenet3dblock import DenseBlock
from densenet3dblock import TransitionBlock
from densenet3dblock import UpsamplingBlock
...
class DenseUNet3d(nn.Module):
    def __init__(self):
        ...
        self.conv_classifier = nn.Conv3d(64, 1, kernel_size=1, stride=1)
