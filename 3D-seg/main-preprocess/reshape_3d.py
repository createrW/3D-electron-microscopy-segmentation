...
test_img, test_mask, _ =  load_and_prepare_3D_data("../data/te/img", "../data/tr/mask", crop_shape=(80, 80, 80, 1), cross_val=False, cross_val_nsplits=0, cross_val_fold=0,
    val_split=0)
...
train_dataset = EmDataset(train_img, train_mask, transforms = None)
...
print(f"The train dataset has {len(train_dataloader)} batch")
print(f"The val dataset has {len(val_dataloader)} batch")
print(f"The test dataset has {len(test_dataloader)} batch")
